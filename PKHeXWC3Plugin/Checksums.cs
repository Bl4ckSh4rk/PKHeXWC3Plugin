namespace WC3Plugin
{
    public static class Checksums
    {
        ...
        public static byte[] FixWC3Checksum(byte[] data)
        {
            ...
            ushort chk2 = GetWC3ChecksumScript(data);
        ...
        public static byte[] FixWN3Checksum(byte[] data)
        {
            ushort chk = GetWN3Checksum(data);
        ...
        public static byte[] FixECTChecksum(byte[] data)
        {
            ...
            data[data.Length - 2] = (byte)(chk >> 16);
            data[data.Length - 1] = (byte)(chk >> 24);
        ...
        public static ushort GetWC3Checksum(byte[] data, uint start, uint length)
        {
            ushort seed = 0x1121;
            ushort tabNum;
            ushort tabVal;
            ...
            {
                tabNum = (ushort)((seed ^ data[start + i]) & 0xFF);
                tabVal = crctable[tabNum];
                tabVal = (ushort)(tabVal & 0xFFFF);
                seed = (ushort)((tabVal ^ (seed >> 8)) & 0xFFFF);
            }

            return (ushort)((seed ^ 0xFFFF) & 0xFFFF);
        }
